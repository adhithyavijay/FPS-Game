...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    {
        //Added By Me
        [Header("Trigger Learning")]
        [SerializeField] TMP_Text messageCenter;
        [SerializeField] TMP_Text healthIndicator;
        ...
        void OnTriggerEnter(Collider other) {
            if(other.name == "WarZoneIndicator"){
                messageCenter.text = "War Zone Ahed";
                //health += 5;
                //healthIndicator.text = health.ToString();
                //Destroy(other.gameObject);
            }

            if(other.name == "HealthPack"){
                messageCenter.text = "Health ++";
                StartCoroutine(Fade());
                health += 5;
                healthIndicator.text = "Health: " + health.ToString();
                Destroy(other.gameObject);
